  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      for (var i = 0; i < data.comments.length; i++) {
        ...
        var fromUser = data.comments[i].from_user;
        var fromStoreOwner = data.comments[i].from_store_owner; // let toUser = data.comments[i].to_user;
